...
#   Write-Output "This is NOT a Server OS. Script will NOT continue!!"
#    Exit
 
#} Else {

#    Write-Output "This is a Server OS. Script will continue!!"

#}

If ( (Test-Port -Address localhost -Port 5986) -ne $false) {

   Write-Output "WinRM HTTPS already Configured. Script will NOT continue!!"
    Exit
 
} Else {

    Write-Output "WinRM HTTPS not Configured. Script will continue!!"
...
Function New-LegacySelfSignedCert
{
    ...
    $AlternativeName += "AnsibleEnabledCertificate"
...
#T.K: this part was missing for cert based auth!
#region Enable cert-based auth
Set-Item -Path WSMan:\localhost\Service\Auth\Certificate -Value $true
if($?)
{
   "Winrm Certificate Authentication Enabled"
  
}
else
{
   "Error enabling Certificate Authentication"
}
#endregion
